...
<div class="panel panel-primary">
    ...
    <form action="" method="POST">
        ...
        <div class="form-group">
            <button class="btn btn-primary"><span class="icon-save"> Guardar proyecto</span></button>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <form action="/categorias" method="POST" class="form-inline">
                ...
                <button class="btn btn-primary"><span class="icon-add_box"> Añadir</span></button>
            </form>
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-sm btn-warning" title="Editar" data-category="{{ $category->id }}">
            ...
            <div class="col-md-6">
                ...
                <table class="table table-bordered">
                    <caption>Lista de niveles</caption>
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Nivel</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $level->name }}</td>
                            <td>
                                <button type="button" class="btn btn-sm btn-warning" title="Editar" data-level="{{ $level->id }}">
                                    <span class="glyphicon glyphicon-pencil"></span>
                                </button>
